try:
    ...
    print("Make sure you have the required images in an 'imgs' folder")
    print("Make sure that Stockfish is marked with the correct path")
    print("Make sure you have the 'chess' and 'pygame' libraries installed (use 'pip install chess and/or pygame')")
